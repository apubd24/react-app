...
const DeviceList1 = () => {
  ...
  return (
    // <div className="space-y-6 max-w-screen-2xl mx-auto px-6">
    <div className="space-y-6 max-w-screen-2xl mx-auto px-6">
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 w-full">
